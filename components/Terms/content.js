...
const TermsContent = () => (
  <TermsStyles>
    ...
    <br />
    <span> Allicin Static Demo</span> is located at:
    <br />
    <address>
      <br />
    </address>
    <p>
      ...
      in full. Do not continue to use Allicin Static Demo's website if you do
    ...
    <p>
      ...
      accordance with and subject to, prevailing law of Massachusetts. Any use
    ...
    <p>
      ...
      from https://allicin-static.now.sh/ for your own personal use subject to
    ...
    <p>
      ...
      visibility associated with the hyperlink outweighs the absence of Allicin
      Static and (d) where the link is in the context of general resource
